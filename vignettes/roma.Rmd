...
The result is an S3 Object, attributes of which can be accessed via $ or via the getAttribute() function. Below is an example of obtaining information for a specific OMA group.
